...
public class IstgActivity extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_istg);
        ...
        istgScn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(IstgActivity.this, InstagramAuthActivity.class);
            ...
            case 0:
                ...
                if (resultCode == RESULT_OK) {
                    ...
                    if (bundle.containsKey(InstagramKitConstants.kSessionKey)) {
                        ...
                        Toast.makeText(IstgActivity.this, "Woohooo!!! User trusts you :) "
